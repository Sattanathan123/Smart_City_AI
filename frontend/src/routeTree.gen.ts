...
const OfficerGisMapRoute = OfficerGisMapRouteImport.update({
  id: '/gis-map',
  path: '/gis-map',
  getParentRoute: () => OfficerRoute,
} as any)
const AdminGisMapRoute = AdminGisMapRouteImport.update({
  id: '/gis-map',
  path: '/gis-map',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/ai-conflict': {
      id: '/ai-conflict'
      path: '/ai-conflict'
      fullPath: '/ai-conflict'
      preLoaderRoute: typeof AiConflictRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/admin': {
      id: '/admin'
    ...
    '/officer/gis-map': {
      id: '/officer/gis-map'
      path: '/gis-map'
      fullPath: '/officer/gis-map'
      preLoaderRoute: typeof OfficerGisMapRouteImport
      parentRoute: typeof OfficerRoute
    }
    '/admin/gis-map': {
      id: '/admin/gis-map'
      path: '/gis-map'
      fullPath: '/admin/gis-map'
      preLoaderRoute: typeof AdminGisMapRouteImport
...
interface AdminRouteChildren {
  AdminGisMapRoute: typeof AdminGisMapRoute
}

const AdminRouteChildren: AdminRouteChildren = {
  AdminGisMapRoute: AdminGisMapRoute,
}

const AdminRouteWithChildren = AdminRoute._addFileChildren(AdminRouteChildren)

interface OfficerRouteChildren {
  OfficerGisMapRoute: typeof OfficerGisMapRoute
}

const OfficerRouteChildren: OfficerRouteChildren = {
  OfficerGisMapRoute: OfficerGisMapRoute,
}
