...
export const departments = ["Road", "Water", "Electricity", "Drainage", "Waste Management"];
...
export const projects: Project[] = [
  ...
  {
    id: "P-1048",
    name: "Sewage Treatment Expansion",
    department: "Drainage",
    location: "Zone 4",
    type: "Infrastructure",
    status: "Planned",
...
export const complaints: Complaint[] = [
  {
    ...
    location: "Zone 5",
    status: "Assigned to Water Department",
    date: "2 days ago",
  },
  {
    id: "C-9002",
    ...
    location: "Zone 2",
    status: "In Progress – Electricity Dept",
    date: "4 days ago",
  },
  {
    id: "C-9003",
    ...
    location: "Zone 3",
    status: "Assigned to Waste Management",
    date: "1 day ago",
  },
  {
    id: "C-9004",
...
export const resolvedUpdates: Complaint[] = [
  ...
  },
  {
    ...
    category: "Street Light Failure",
    location: "Zone 6",
    status: "Resolved – Electricity Dept",
    date: "2 days ago",
    resolved: true,
  },
  {
    ...
    category: "Garbage Issue",
    location: "Zone 4",
    status: "Resolved – Waste Management",
    date: "3 days ago",
    resolved: true,
  },
];
